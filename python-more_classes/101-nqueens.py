...
def print_result(m_queen, nqueen):
    """ Method that prints list with the Queens positions
...
def Queen(m_queen, nqueen):
    """ Recursive function that execute the Backtracking algorithm
    Args:
        m_queen: array that has the queens positions
        nqueen: queen number
...
def solveNQueen(size):
    """ Function that invokes the Backtracking algorith
